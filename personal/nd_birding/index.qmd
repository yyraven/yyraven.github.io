...
- ***Red-billed leiothrix***, its Chinese common name's literal meaning is 'red-billed missing-you-bird', how cute it is?
:::
...
Now I've observed <code>`r nrow(bird_list)`</code> bird species, in which <code>`r result$count[result$location == "US"]`</code> of them were spotted in the United States, and <code>`r result$count[result$location == "CN"]`</code> of them were spotted in China.
...
- **200 bird species spotted**: Aug 2026
...
-   **Last Visited**: Sep 2026
-   **Birds**: Black-crowned Night Heron, Little Grebe, Great Crested Grebe, Azure-winged Magpie, Light-vented Bulbul, Little Egret, Red-rumped Swallow, Pheasant-tailed Jacana, Red-billed Starling, Eurasian Moorhen, Chinese Blackbird, Oriental Magpie-Robin, Masked Laughingthrush, Spotted Dove, Long-tailed Shrike
-   **Comments**: Beautiful place, regionally well-known birding hotspot and tourist attraction with reeds, waterlilies, lotus, water caltrops (attract moorhens and jacanas), and other water plants all over the ponds and wetlands. Better avoid the crowds if going birding since water sports are popular in this park. 
...
#### ![](pixelart/greatcormorant_s.png) Suzhou, CN: Shui Ba Xian Ecological Park 水八仙生态文化园
...
-   **Comments**: Paddy fields & part of Chenhu Lake. People raise fish in Chenhu Lake so it attracts a lot of fish-eating bird species. Nice place to watch shorebirds and ducks, has a relatively high entrance fee, though. 'Shui Ba Xian' (literal: 8 water gods) means 8 different water-borne vegetables which Suzhou local people enjoy eating, including 茭白 (water bamboo shoots), 莲藕 (lotus root), 水芹 (water celery), 鸡头米 (fox nuts), 慈姑 (arrowhead), 荸荠 (water chestnut), 莼菜 (water shield), &菱角 (water caltrop). They are often harvested in fall, so in winter, the fields are free for birds to live. 
-   **Links**: [ebird-水八仙生态文化园](https://ebird.org/hotspot/L17507817)
-   **Related Posts**: [Dec '25 Winter Migration](../251229_birding_suzhou/index.qmd)
